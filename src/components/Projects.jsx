  ...
  return (
    <section className="relative w-full py-32 flex flex-col items-center justify-center bg-[var(--bg)]" id="projects">
      <div className="w-full flex justify-center mb-16">
        <h2 className="magic-title text-center">PROJECTS</h2>
      </div>
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto px-6 mt-20 flex flex-col gap-40">
          ...
          <div className="w-full aspect-video rounded-3xl border-2 border-[var(--glass-border)] bg-[var(--glass-bg)] shadow-2xl overflow-hidden relative flex items-center justify-center p-4">
            <svg className="w-full h-full drop-shadow-2xl" viewBox="0 0 1000 600" preserveAspectRatio="xMidYMid meet">
              ...
              <g transformOrigin="500 300">
                <path d="M0,100 L1000,100 M0,200 L1000,200 M0,300 L1000,300 M0,400 L1000,400 M0,500 L1000,500" stroke="var(--glass-border)" strokeWidth="1"/>
                <path d="M200,0 L200,600 M400,0 L400,600 M600,0 L600,600 M800,0 L800,600" stroke="var(--glass-border)" strokeWidth="1"/>
                ...
                <motion.g initial={{ opacity: 0, scale: 0.5 }} whileInView={{ opacity: 1, scale: 1 }} transition={{ duration: 1, delay: 0.5 }}>
                  <circle cx="500" cy="300" r="280" fill="var(--bg)" stroke="var(--accent)" strokeWidth="4"/>
                ...
                <motion.g initial={{ opacity: 0, x: -50 }} whileInView={{ opacity: 1, x: 0 }} transition={{ delay: 1.5, duration: 0.5 }}>
                  <rect x="40" y="40" width="320" height="240" fill="var(--bg)" stroke="var(--accent)" strokeWidth="2" rx="8" />
                  <path d="M40,80 L360,80" stroke="var(--accent)" strokeWidth="1.5"/>
                  <text x="60" y="65" fill="var(--fg)" fontFamily="var(--font-mono)" fontSize="14" fontWeight="bold">SPECTRAL_BIOMETRIC_LOG</text>
        ...
        >
          <div className="order-2 lg:order-1 w-full aspect-video rounded-3xl border-2 border-[var(--glass-border)] bg-[var(--glass-bg)] shadow-2xl overflow-hidden relative flex items-center justify-center p-4">
            <svg className="w-full h-full drop-shadow-2xl" viewBox="0 0 1000 600" preserveAspectRatio="xMidYMid meet">
              <rect x="600" y="100" width="150" height="400" fill="none" stroke="var(--fg)" strokeWidth="4" strokeDasharray="20 20"/>
              <text x="650" y="90" fill="var(--text-muted)" fontFamily="var(--font-mono)" fontSize="20">BAY 4</text>
              <motion.path 
              ...
              >
                <rect x="-40" y="-25" width="80" height="50" rx="10" fill="var(--fg)"/>
                <rect x="-20" y="-20" width="40" height="40" rx="5" fill="var(--bg)"/>
              </motion.g>
              ...
              >
                ...
                <text x="255" y="234" fill="var(--bg)" fontFamily="var(--font-mono)" fontSize="12" fontWeight="bold">CAR: 0.98</text>
              </motion.g>
              ...
              <motion.g 
                ...
                transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }}
              >
                <rect x="700" y="300" width="200" height="60" fill="var(--bg)" stroke="var(--accent)" strokeWidth="2" rx="5"/>
          ...
          <div className="w-full aspect-video rounded-3xl border-2 border-[var(--glass-border)] bg-[var(--glass-bg)] shadow-2xl overflow-hidden relative flex items-center justify-center p-4">
            <svg className="w-full h-full drop-shadow-2xl" viewBox="0 0 1000 600" preserveAspectRatio="xMidYMid meet">
              <g id="lex-node-user" transform="translate(150, 300)">
                <circle cx="0" cy="0" r="35" fill="var(--bg)" stroke="var(--fg)" strokeWidth="3"/>
                <text x="-16" y="5" fill="var(--fg)" fontFamily="var(--font-outfit)" fontSize="14">USER</text>
              </g>
              <g id="lex-node-api" transform="translate(380, 200)">
                <circle cx="0" cy="0" r="35" fill="var(--bg)" stroke="var(--fg)" strokeWidth="3"/>
                <text x="-12" y="5" fill="var(--fg)" fontFamily="var(--font-outfit)" fontSize="14">API</text>
              </g>
              <g id="lex-node-lambda" transform="translate(380, 400)">
                <circle cx="0" cy="0" r="35" fill="var(--bg)" stroke="var(--accent)" strokeWidth="3"/>
                <text x="-25" y="5" fill="var(--accent)" fontFamily="var(--font-outfit)" fontSize="14">LAMBDA</text>
              </g>
              <g id="lex-node-db" transform="translate(620, 400)">
                <circle cx="0" cy="0" r="35" fill="var(--bg)" stroke="var(--fg)" strokeWidth="3"/>
                <text x="-10" y="5" fill="var(--fg)" fontFamily="var(--font-outfit)" fontSize="14">DB</text>
              </g>
              <g id="lex-node-llama" transform="translate(620, 200)">
                <circle cx="0" cy="0" r="35" fill="var(--bg)" stroke="var(--accent)" strokeWidth="3"/>
                <text x="-22" y="5" fill="var(--accent)" fontFamily="var(--font-outfit)" fontSize="14">LLaMA3</text>
              </g>

              <path d="M185,300 L345,200" stroke="var(--text-muted)" strokeWidth="2" strokeDasharray="5 5"/>
              <path d="M380,235 L380,365" stroke="var(--text-muted)" strokeWidth="2" strokeDasharray="5 5"/>
              <path d="M415,400 L585,400" stroke="var(--text-muted)" strokeWidth="2" strokeDasharray="5 5"/>
              <path d="M415,400 L585,200" stroke="var(--text-muted)" strokeWidth="2" strokeDasharray="5 5"/>
              <path d="M585,200 L185,300" stroke="var(--text-muted)" strokeWidth="2" strokeDasharray="5 5"/>
              ...
              <motion.circle animate={{ cx: [585, 185], cy: [200, 300], opacity: [0, 1, 0] }} transition={{ duration: 4, repeat: Infinity, ease: "linear", delay: 2.5 }} r="8" fill="var(--fg)"/>
              ...
              <motion.g transform="translate(680, 250)" animate={{ opacity: [0, 0, 1, 0] }} transition={{ duration: 4, repeat: Infinity }}>
                <rect x="0" y="0" width="160" height="80" fill="var(--bg)" stroke="var(--accent)" strokeWidth="2" rx="5"/>
                <text x="15" y="30" fill="var(--fg)" fontFamily="var(--font-mono)" fontSize="12">QUERY RESOLVED</text>
          ...
          <div className="order-2 lg:order-1 w-full aspect-video rounded-3xl border-2 border-[var(--glass-border)] bg-[var(--glass-bg)] shadow-2xl overflow-hidden relative flex items-center justify-center p-4">
            <svg className="w-full h-full drop-shadow-2xl" viewBox="0 0 1000 600" preserveAspectRatio="xMidYMid meet">
              ...
              <motion.g transform="translate(50, 480)" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ delay: 0.5 }}>
                <rect x="0" y="0" width="380" height="80" fill="var(--bg)" stroke="var(--glass-border)" strokeWidth="2" rx="5"/>
                <text x="20" y="30" fill="var(--text-muted)" fontFamily="var(--font-mono)" fontSize="12">FEATURES EXTRACTION:</text>
              ...
              <motion.g initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ delay: 1 }} transform="translate(550, 100)">
                ...
                <text x="126" y="105" fill="var(--accent)" fontFamily="var(--font-outfit)" fontSize="14" fontWeight="bold">BP&lt;90</text>
                ...
                <text x="210" y="225" fill="var(--fg)" fontFamily="var(--font-outfit)" fontSize="12">Age&gt;65</text>

                <circle cx="30" cy="320" r="18" fill="var(--bg)" stroke="var(--accent)" strokeWidth="3"/>
                <text x="12" y="324" fill="var(--accent)" fontFamily="var(--font-outfit)" fontSize="11">Sepsis</text>
                
                <circle cx="110" cy="320" r="18" fill="var(--bg)" stroke="var(--fg)" strokeWidth="2"/>
                ...
                <motion.g transform="translate(-20, 380)" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ delay: 1.5 }}>
                  ...
                  <rect x="20" y="70" width="220" height="8" fill="var(--glass-border)" rx="4"/>
